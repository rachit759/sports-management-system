...
CREATE TABLE `meet` (
  ...
  `ToM` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`E_ID`,`Roll_No`),
  KEY `Roll_No` (`Roll_No`),
  CONSTRAINT `meet_ibfk_1` FOREIGN KEY (`Roll_No`) REFERENCES `students_info` (`Roll_No`),
  CONSTRAINT `meet_ibfk_2` FOREIGN KEY (`E_ID`) REFERENCES `equipments` (`Eq_ID`)
