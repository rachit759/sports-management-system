...
CREATE TABLE `employee_phone` (
  ...
  PRIMARY KEY (`E_ID`,`phone_no`),
  CONSTRAINT `employee_phone_ibfk_1` FOREIGN KEY (`E_ID`) REFERENCES `employee_info` (`E_ID`)
...
INSERT INTO `employee_phone` VALUES (1001,'9874651235'),(1002,'9704956875'),(1003,'7890467382'),(2002,'8945627458'),(3002,'7869541236'),(4003,'8579462846');
