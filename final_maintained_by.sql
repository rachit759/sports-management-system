...
CREATE TABLE `maintained_by` (
  ...
  `last_man` date DEFAULT NULL,
  `next_man` date DEFAULT NULL,
  KEY `place_id` (`place_id`),
  CONSTRAINT `maintained_by_ibfk_1` FOREIGN KEY (`place_id`) REFERENCES `grounds` (`place_id`)
...
-- Dump completed on 2022-03-15 21:58:02
